export function Experience() {
  return (
    <section id="experience" className="w-full bg-white py-12 sm:py-20 lg:py-24 scroll-mt-20 sm:scroll-mt-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <header className="text-center">
          <p className="text-xs sm:text-sm font-semibold tracking-wide text-gray-500">— Education &amp; Work</p>
          <h2 className="mt-2 text-2xl sm:text-4xl font-bold text-forest md:text-5xl">
            My Academic and Professional Journey
          </h2>
        </header>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-16 mt-10 sm:mt-16">
          {/* Education */}
          <div>
            <div className="flex items-center gap-3">
              <div className="inline-flex items-center gap-2 rounded-full bg-[#FFB800]/10 px-3.5 py-1.5 sm:px-4 sm:py-2">
                {/* Graduation cap */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  className="w-4 h-4 sm:w-5 sm:h-5 text-[#FFB800]"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="1.8"
                >
                ...
                <h3 className="text-lg sm:text-2xl font-bold text-forest">Education</h3>
              </div>
            </div>

            <div className="mt-6 sm:mt-8 pl-4 border-l-2 border-gray-100 flex flex-col gap-6 sm:gap-10">
              {/* Timeline Item 1 */}
              <div className="group relative">
                ...
                <div className="rounded-xl p-3 sm:p-4 transition-colors duration-300 group-hover:bg-[#1E392A]/5">
                  <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">
                    2024 - Present
                  </p>
                  <h4 className="text-base sm:text-xl font-bold text-forest mt-1">
          ...
          <div>
            <div className="flex items-center gap-3">
              <div className="inline-flex items-center gap-2 rounded-full bg-[#FFB800]/10 px-3.5 py-1.5 sm:px-4 sm:py-2">
                ...
                <h3 className="text-lg sm:text-2xl font-bold text-forest">Work Experience</h3>
              </div>
            </div>
